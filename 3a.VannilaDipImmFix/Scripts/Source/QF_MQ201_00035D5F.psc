...
while loc_itemID
	...
	Form loc_item = loc_player.GetNthForm(loc_itemID)
	if loc_item == Alias_PartyOutfit.GetRef().GetBaseObject() || loc_item == Alias_PartyBoots.GetRef().GetBaseObject() || loc_item == Alias_PartyInvitation.GetRef().GetBaseObject()
		loc_transfer = false
	endif
	if loc_transfer
